                            ...
                            {report.title && (
                                <div className="grid grid-cols-2 mx-28 gap-5">
                                    <div className="border-r-2 px-5">
                                        <div className="text-xl font-bold my-3">Thông tin người báo cáo</div>
                                        <div className="my-3">
                                            <div className="mb-2">Mã số sinh viên</div>
                                            <div className="border p-3 rounded ">{report.student.username}</div>
                                        </div>
                                        <div className="my-3">
                                            <div className="mb-2">Họ tên</div>
                                            <div className="border p-3 rounded ">{report.student.fullName}</div>
                                        </div>
                                        <div className="my-3">
                                            <div className="mb-2">Email</div>
                                            <div className="border p-3 rounded ">{report.student.email}</div>
                                        </div>
                                        <div className="my-3">
                                            <div className="mb-2">Tiêu đề</div>
                                            <div className="border p-3 rounded ">{report.title}</div>
                                        </div>

                                        <div className="my-3">
                                            <div className="mb-2">Nội dung báo cáo</div>
                                            <div className="border p-3 rounded ">{report.content}</div>
                                        </div>
                                    </div>
                                    <div>
                                        <div className="text-xl font-bold">Thông tin sản phẩm bị báo cáo</div>

                                        <div className="my-3">
                                            <div className="mb-2">Chủ sở hữu</div>
                                            <div className="border p-3 rounded ">
                                                {report.reportedStudent.username} - {report.reportedStudent.fullName}
                                            </div>
                                        </div>
                                        <div className="my-3">
                                            <div className="mb-2">Điện thoại</div>
                                            <div className="border p-3 rounded ">
                                                {report.reportedStudent.phoneNumber}
                                            </div>
                                        </div>
                                        <div className="my-3">
                                            <div className="mb-2">Tên sản phẩm</div>
                                            <div className="border p-3 rounded ">{report.product.name}</div>
                                        </div>
                                        <div className="my-3">
                                            <div className="mb-2">Hình ảnh</div>
                                            <div className="border p-3 rounded flex">
                                                {JSON.parse(report.product.images).map((image, index) => (
                                                    <img key={index} className="w-32 mr-3" alt="product" src={image} />
                                                ))}
                                            </div>
                                        </div>
                                        <div className="my-3">
                                            <div className="mb-2">Link sản phẩm</div>
                                            <div className="border p-3 rounded text-blue-700">
                                                <a
                                                    rel="noreferrer"
                                                    target="_blank"
                                                    href={"http://localhost:3000/product/" + report.product.id}
                                                >
