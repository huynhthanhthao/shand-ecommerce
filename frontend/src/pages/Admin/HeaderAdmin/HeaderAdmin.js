        ...
        <div className="header-admin flex justify-between items-center px-10 bg-[#1f2937]  py-2">
            <div className="flex">
                <div className="flex items-center mr-36">
                    <img src={require("assets/images/admin.jpg")} className="w-10 mr-2 rounded" alt="admin " />
                    <p className="font-bold text-white">{account.fullName}</p>
                </div>
                <div className="flex bg-white p-2 rounded w-[550px]">
                    <svg className="w-5 mr-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                        <path
                            className="fill-[#1f2937]"
                            d="M416 208c0 45.9-14.9 88.3-40 122.7L502.6 457.4c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L330.7 376c-34.4 25.2-76.8 40-122.7 40C93.1 416 0 322.9 0 208S93.1 0 208 0S416 93.1 416 208zM208 352a144 144 0 1 0 0-288 144 144 0 1 0 0 288z"
                        />
                    </svg>
                    <input className="input outline-none border-none" type="text" placeholder="search" />
                </div>
            </div>
