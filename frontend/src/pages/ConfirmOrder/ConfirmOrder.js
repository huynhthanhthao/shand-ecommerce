...
function ConfirmOrder() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            await Promise.all([
                ...
                getTransaction({ username: account.username }, dispatch),
            ]);
        };
    ...
    const { addressDefault: address } = useSelector(
                        ...
                        <div className="bg-white rounded-sm my-4 shadow ">
                            <div className="px-6 py-3">
                                <div className="flex justify-between mb-3">
                                    ...
                                    <p className="text-sm font-bold">
                                        {orderConfirm.reduce(function (
                                            total,
                                            currentValue
                                        ) {
                                            return (
                                                total +
                                                currentValue.product.detail
                                                    .price *
                                                    currentValue.amount
                                            );
                                        },
                                ...
                                >
                                    ...
                                    <input
                                        ...
                                        type="number"
                                        name="total"
                                        value={orderConfirm.reduce(function (
                                            total,
                                            currentValue
                                        ) {
                                            return (
