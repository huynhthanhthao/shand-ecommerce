            ...
            <div className="grid grid-cols-2 gap-3">
                ...
                >
                    ...
                    <div className="grid grid-cols-3 gap-5 mt-5">
                        <div className="flex flex-col p-2 justify-center items-center bg-yellow-400 w-52 rounded text-white shadow-xl shadow-yellow-500/20">
                            ...
                            Mua bán đồ cũ giá rẻ
                        </div>
                        <div className="flex flex-col p-2 justify-center items-center bg-blue-400 w-52 rounded text-white shadow-xl shadow-blue-500/20">
                            <p className=" flex font-bold uppercase">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 512 512"
                        ...
                        <div className="flex flex-col p-2 justify-center items-center bg-purple-400 w-52 rounded text-white shadow-xl shadow-purple-500/20">
                            <p className=" flex font-bold uppercase">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 384 512"
                    ...
                    <div className="flex items-end mx-20">
                        <div className="w-52  flex flex-col items-center">
                            <div className="relative rounded-full ">
                                <img
                                    src="https://galaxylands.com.vn/wp-content/uploads/2022/12/tieu-su-ca-si-rose-blackpink-12.jpg"
                                    alt="top-3"
                            ...
                            <p className="font-bold text-sm mt-2 mb-3">
                                B1906570
                            </p>
                        </div>
                        <div className="w-52  flex flex-col items-center">
