    ...
    return (
        <div className=" flex flex-col">
            ...
            <div className="border-t my-3 py-5">
                ...
                <div className={transaction.fullName !== undefined ? "hidden" : ""}>
                    {showFormAdd || (
                        <button
                ...
                {showFormAdd && <TransactionFormAdd setShowFormAdd={setShowFormAdd} />}
                {showFormUpdate && <TransactionFormUpdate setShowFormUpdate={setShowFormUpdate} />}
            </div>
        </div>
    );
}
