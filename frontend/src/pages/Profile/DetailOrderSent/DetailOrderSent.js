    ...
    return (
        <div className="add-product">
            <label className="font-bold flex">
                <p className="text-[#666]">Đơn hàng đã đặt&nbsp;/&nbsp;</p>
                Chi tiết đơn hàng
            </label>
            <div className=" py-5 border-t my-3 bg-white text-sm flex flex-col">
                ...
                <div className="grid grid-cols-2 gap-3">
                    <div className="border p-2 mt-5 border-dashed flex justify-between">
                        <div>
                            ...
                            <div className="flex items-center my-1 ">
                                ...
                                <p className="font-bold">Người nhận trả</p>
                            </div>
                            <div className="flex items-center my-1 ">
                                <p className="">Tình trạng:&nbsp;</p>
                                <p className="font-bold">Đã xác nhận</p>
                            </div>
                        </div>
                        <div className="w-36 h-8 border border-dashed border-green-500 p-1 text-green-500 text-center">
                            Đã xác nhận
                        </div>
                    </div>
                    <div className="border p-2 mt-5 border-dashed ">
                        ...
                        <div>
                            <p className="font-bold">Thao Huynh -</p>
                            <p className="my-1 ">0355219791</p>
                        </div>
                        <p>Can Tho - Xã Bành Trạch - Huyện Ba Bể - Bắc Kạn</p>
                    </div>
                </div>
                    ...
                    <table className="table-fixed w-full border-separate border-spacing-2 border border-white">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td className="text-center">5.900đ</td>
                                <td className="text-center">2</td>
                                <td className="text-center">11.800đ</td>
                            </tr>
                            <tr>
                                <td className="flex items-start ">
                                    <img
                ...
                <button className="btn3 p-2 mt-3  w-64 mx-auto ">
